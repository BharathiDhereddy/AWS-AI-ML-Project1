...
def get_pet_labels(image_dir):
       ...
       # isn't an pet image file
        if in_files[idx][0] != ".":
           ...
           #          that's created as an empty string ABOVE
            ...
            petimage = in_files[idx].lower()
            word_list_petimage = petimage.split("_")


            pet_name =""

            for words in word_list_petimage:
                if words.isalpha():
                    pet_name += words + " "
   ...
   # TODO 2b Replace None with the results_dic dictionary that you created with this
    # function
    return results_dic
